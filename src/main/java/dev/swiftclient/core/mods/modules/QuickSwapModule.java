...
public final class QuickSwapModule extends Module {
   public QuickSwapModule() {
      super("quick_swap", "Quick Swap", "Intervertit instantanement Plastron et Elytres (ou main gauche) avec une touche.", "Utility", "shirt", false);
      // No behaviour yet: nothing reads "quick_swap". Hidden until implemented.
      this.notImplemented();
